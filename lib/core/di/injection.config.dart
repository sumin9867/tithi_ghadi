...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i125.SplashCubit>(
      () => _i125.SplashCubit(gh<_i558.FlutterSecureStorage>()),
    );
    ...
    gh.factory<_i299.FacebookLoginUseCase>(
      () => _i299.FacebookLoginUseCase(gh<_i787.AuthRepository>()),
    );
    gh.factory<_i698.AuthCubit>(
      () => _i698.AuthCubit(
        gh<_i188.LoginUseCase>(),
        gh<_i850.GoogleLoginUseCase>(),
        gh<_i299.FacebookLoginUseCase>(),
      ),
    );
